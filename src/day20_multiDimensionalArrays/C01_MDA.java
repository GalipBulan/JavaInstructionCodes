...
public class C01_MDA {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(arr.length); // 5 iicnde olan aray leri yazdirir


        System.out.println(Arrays.toString(arr[4])); // [3, 6, 8, 0]
        ...
        System.out.println(Arrays.toString(arr[1]));  // [1, 2] ic index i Array olarak yaztdirir
